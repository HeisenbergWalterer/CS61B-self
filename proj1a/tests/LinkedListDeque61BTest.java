...
public class LinkedListDeque61BTest {
    ...
    public void removeFirstAndLastTest() {
        ...
        assertThat(lld1.removeFirst()).isEqualTo("front"); // 返回值无误
        assertThat(lld1.toList()).containsExactly("middle", "back").inOrder(); // 删除功能无误

        assertThat(lld1.removeLast()).isEqualTo("back"); // 返回值无误
